...
import com.vaadin.data.util.BeanItemContainer;
  ...
  public class TestSampleBean implements Comparable<Object>, Serializable {
    ...
    public TestSampleBean(String id, String code, String type, String sampleType, String secondaryName, String additionalInfo, String externalDB, String properties) {
      super();
      this.id = id;
      this.code = code;
      this.type = type;
