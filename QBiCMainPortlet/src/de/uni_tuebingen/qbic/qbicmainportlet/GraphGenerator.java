...
public class GraphGenerator {
  ...
  public GraphGenerator(ProjectBean projectBean, OpenBisClient openBisClient) throws IOException {
    ...
    try {
      ...
      // this.open_client.getExperimentsOfProjectByIdentifier(p.getIdentifier());

      // List<Experiment> exps =
      // dh.openBisClient.getExperimentsOfProjectByIdentifier(p.getIdentifier());
      ...
      for (SampleBean s : samps) {
        ...
        // species = dh.openBisClient.getCVLabelForProperty(pType,
