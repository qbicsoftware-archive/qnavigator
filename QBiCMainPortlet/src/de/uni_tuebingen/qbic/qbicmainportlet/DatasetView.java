  ...
  private void buildLayout() {
      ...
      public void valueChange(ValueChangeEvent event) {
        ...
        if (currentSelectedTableIndices != null) {
          ...
          if (currentSelectedTableIndices.size() == 1) {
            ...
            ResourceURL resourceUrl = (ResourceURL)portletSession.getAttribute("resURL", PortletSession.APPLICATION_SCOPE);
    ...
    this.table.addValueChangeListener(new ValueChangeListener() {
      ...
      public void valueChange(ValueChangeEvent event) {
        ...
        // TODO: No hardcoding!!
        if (datasetType.equals("FASTQC") || datasetType.equals("QCML") || datasetType.equals("BAM") || datasetType.equals("VCF")) {
      ...
      public void buttonClick(ClickEvent event) {
        ...
        try {
          ...
          if (datasetType.equals("QCML")) {
            ...
            String hostTmp = "http://localhost:8080/web/guest/mainportlet?p_p_id=QbicmainportletApplicationPortlet_WAR_QBiCMainPortlet_INSTANCE_5pPd5JQ8uGOt&p_p_lifecycle=2&p_p_state=normal&p_p_mode=view&p_p_cacheability=cacheLevelPage&p_p_col_id=column-1&p_p_col_count=1";
            hostTmp += "&qbicsession=" + UI.getCurrent().getSession().getAttribute("gv-restapi-session") + "&someblabla=";
            //String hostTmp = themedisplay.getURLPortal() + UI.getCurrent().getPage().getLocation().getPath() + "?qbicsession=" + UI.getCurrent().getSession().getAttribute("gv-restapi-session") + "&someblabla=" ;
